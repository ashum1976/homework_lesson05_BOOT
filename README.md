...
-  Начальный образ загрузки системы **Initial RAM disk (initrd)**. Содержит модули ядра необходимые для работы устройств при дальнейшей инициализации системы и скрипты их загрузки.
